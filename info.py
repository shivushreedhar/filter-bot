...
BOT_TOKEN = environ.get("BOT_TOKEN", "7100865579:AAGbxpOj0-uGqXnl3PwYgPvPoC69yabZHd8")
...
# Database Channel
CHANNELS = [
    int(ch.strip()) if id_pattern.fullmatch(ch.strip()) else ch.strip()
    for ch in environ.get(
        "CHANNELS",
        "-1001714589113,-1002035953699"
    ).split(",")
]

# ForceSub Channel & Log Channels
AUTH_CHANNEL = int(environ.get("AUTH_CHANNEL", "-1002088921495"))
AUTH_REQ_CHANNEL = int(environ.get("AUTH_REQ_CHANNEL", "-1001994864317"))
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1001994864317"))
LOG_API_CHANNEL = int(environ.get("LOG_API_CHANNEL", "-1001994864317"))
LOG_VR_CHANNEL = int(environ.get("LOG_VR_CHANNEL", "-1001994864317"))

# MongoDB
DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://bshegdeadmin:bsadmin12@bshegde.4aw32h2.mongodb.net/bshegde?retryWrites=true&w=majority&tls=true&appName=Bshegde")
DATABASE_NAME = environ.get("DATABASE_NAME", "bshegde")

# Files index database url
FILES_DATABASE = environ.get("FILES_DATABASE", "mongodb+srv://bshegdeadmin:bsadmin12@bshegde.4aw32h2.mongodb.net/bshegde?retryWrites=true&w=majority&tls=true&appName=Bshegde")
COLLECTION_NAME = environ.get("COLLECTION_NAME", "jisshu")

# Other Channel's
SUPPORT_GROUP = int(environ.get("SUPPORT_GROUP", "-1002295837366"))
DELETE_CHANNELS = int(environ.get("DELETE_CHANNELS", "0"))
request_channel = environ.get("REQUEST_CHANNEL", "-1001994864317")
REQUEST_CHANNEL = (
    int(request_channel)
...
SUPPORT_CHAT = environ.get("SUPPORT_CHAT", "https://t.me/+udIwB3eKUVwzODM1")
MOVIE_GROUP_LINK = environ.get("MOVIE_GROUP_LINK", "https://t.me/+udIwB3eKUVwzODM1")
...
SHORTENER_API3 = environ.get(
    "SHORTENER_API3", "31df09b3a5df1a7898a19dac1b6dccd570abea62e"
)
...
START_IMG = (
    environ.get(
        "START_IMG",
        "https://graph.org/file/3f9938e1b5e26ae099d23-f46e4a0f9a8c85ab38.jpg",
    )
).split()
FORCESUB_IMG = environ.get("FORCESUB_IMG", "https://graph.org/file/3f9938e1b5e26ae099d23-f46e4a0f9a8c85ab38.jpg")
REFER_PICS = (environ.get("REFER_PICS", "https://graph.org/file/3f9938e1b5e26ae099d23-f46e4a0f9a8c85ab38.jpg")).split()
PAYPICS = (
    environ.get("PAYPICS", "https://graph.org/file/3f9938e1b5e26ae099d23-f46e4a0f9a8c85ab38.jpg")
).split()
SUBSCRIPTION = environ.get(
    "SUBSCRIPTION", "https://graph.org/file/3f9938e1b5e26ae099d23-f46e4a0f9a8c85ab38.jpg"
)
REACTIONS = ["👀", "😱", "🔥", "😍", "🎉", "🥰", "😇", "⚡"]
